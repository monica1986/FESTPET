...
{
    public partial class RedesInteres : System.Web.UI.Page
    {
        ...
        protected void botonAgrgarIdenticos_Click(object sender, EventArgs e)
        {
            Response.Redirect("posibleAmigos.aspx");
        }
    }
}